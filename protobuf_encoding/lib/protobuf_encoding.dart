...
library protobuf_encoding;

bool isRepeated(int fieldType) => (fieldType & PbFieldType.REPEATED_BIT) != 0;

bool isRequired(int fieldType) => (fieldType & PbFieldType.REQUIRED_BIT) != 0;

bool isEnum(int fieldType) =>
    PbFieldType.baseType(fieldType) == PbFieldType.ENUM_BIT;

bool isBytes(int fieldType) =>
    PbFieldType.baseType(fieldType) == PbFieldType.BYTES_BIT;

bool isGroupOrMessage(int fieldType) =>
    (fieldType & (PbFieldType.GROUP_BIT | PbFieldType.MESSAGE_BIT)) != 0;

bool isMapField(int fieldType) => (fieldType & PbFieldType.MAP_BIT) != 0;
